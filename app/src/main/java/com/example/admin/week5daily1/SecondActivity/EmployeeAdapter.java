package com.example.admin.week5daily1.SecondActivity;
...
import com.example.admin.week5daily1.R;
import com.example.admin.week5daily1.model.Employee;
...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from( viewGroup.getContext() ).inflate( R.layout.employee_adapter_list, viewGroup, false );
